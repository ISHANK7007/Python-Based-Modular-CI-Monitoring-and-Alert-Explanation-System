...
def run():
    print("=== Test: Nested Group ===")

    log_path = "nested_log.txt"
    with open(log_path, "w", encoding="utf-8") as f:
        f.write("##[group]Outer group\n")
        f.write("##[group]Inner setup\n")
        f.write("Setting up environment\n")
        f.write("##[endgroup]\n")
        f.write("##[endgroup]\n")
    ...
    print("\n=== Tokenized Segments ===")
    if not segments:
        print("No segments were created. Check group tracking and grouping logic.\n")
        return
